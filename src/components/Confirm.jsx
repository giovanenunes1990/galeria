                ...
                <View style={[css.dFlex, css.alignItemsEnd, css.container, css.px1, css.mb1, ]}>
                    <View style={{flex: 1}}>
                        ...
                        <View style={[css.dFlex, css.justifyContentBetween, css.mb2, css.ml1,css.px1]}>
                            ...
                            <TouchableHighlight  underlayColor="#ba8a8c" style={[css.btnSecondary]} onPress={() => props.negative()} >
                                <Text style={css.textBtnSecondary}>NÃO</Text>
                            </TouchableHighlight>
                            <TouchableHighlight  underlayColor="#ba8a8c" style={[css.btnDanger, css.px2]} onPress={() =>  props.positive()} >
